...
Flags:
  ...
  * `--expiresAt`: Set a future UTC date time string (ISO8601). After this date, the test will be automatically deleted. (Min=24 hrs, Max=2 years) e.g.: 2025-12-31T23:59:59Z (Default: Expires 1 year from creation date.: `2027-05-07T10:11:50.149Z`) (string),
  * `--cookie-jar`: Set cookies by specifying a path to a Netscape formatted cookie jar file.,

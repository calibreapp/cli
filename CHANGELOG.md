...
- Added support for host blocking to `calibre test create` command via new `--blocked-hosts` flag. Supports wildcard patterns (e.g., `*.google-analytics.com`), comma-separated lists, JSON arrays, or file paths.
